...
struct ModelInitData {
	...
	void* m_expandConstantBuffer[MAX_EXPAND_CONSTANT_BUFFER] = { nullptr };							//ユーザー拡張の定数バッファ。
	int m_expandConstantBufferSize[MAX_EXPAND_CONSTANT_BUFFER] = { 0 };								//ユーザー拡張の定数バッファのサイズ。
